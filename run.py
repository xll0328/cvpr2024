...
def run_normal(args):
    ...
    save_path = os.path.join(args.res_save_dir, \
                        f'test{args.num}{args.datasetName}-{args.train_mode}.csv')
...
def parse_args():
    ...
    parser.add_argument('--model_save_dir', type=str, default='results/models_cvpr2024',
                        help='path to save results.')
    parser.add_argument('--res_save_dir', type=str, default='results/results_cvpr2024',
                        help='path to save results.')
