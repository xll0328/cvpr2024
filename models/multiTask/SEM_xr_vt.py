...
class SEM(nn.Module):
    def __init__(self, args):
        ...
        self.post_fusion_layer_1 = nn.Linear(args.video_out +82*self.embedding_size, args.post_fusion_dim+args.text_out)
    ...
    def forward(self, text, audio, video):
        ...
        #print(c_emb.size())
        #print(c_pred.size()) 
        c_emb = torch.cat((text_concept_emb, video_concept_emb), dim=1)
        a,b,c = c_emb.shape
